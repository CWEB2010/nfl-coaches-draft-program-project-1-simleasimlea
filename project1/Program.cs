	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			while (primingValue != "X")
			{
				...
				Console.WriteLine("Who do you wish to draft? Enter the player's number + enter" +
						"\nand your selection will be evaluated.");
				...
				for (int i = 0; i < Roster.GetLength(0); i++) //outer loop control rows
				{
					...
					{
						Console.WriteLine("You have chosen " + selection + "which matched a player on the roster: " + Roster[i, 0]);
